		...
		editRow2: function(jq, index){
			...
			function _add(index, row){
					//if (index == undefined){
						...
						opts.editIndex = dg.datagrid('getRows').length;
					//} //else {
				...
				dg.datagrid('beginEdit', opts.index);
				dg.datagrid('selectRow', opts.index);
				if (!dg.edatagrid('isEditing', index)){
							return;
						}
				opts.editIndex = index;
