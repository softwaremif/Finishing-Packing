...
function KlikPrint() {
    ...
    const query = Object.entries(params)
        ...
        .join('&');
    window.location.href = `{{ route('pdf.ct') }}?${query}`;
}
</script>
@endsection
...
<div class="main-wrapper">
    <div class="container-fluid p-4">
        <div class="d-flex flex-column">
            <div class="p-2">
                <span class="txt-000000-700-24-28">Laporan Pembelian Cash / Tempo</span>
            </div>
            ...
            <div class="d-flex flex-wrap p-0 pb-2 gap-2 align-items-center">
                ...
                <div class="p-0">
                    Dari: <input id="SelectStart" name="SelectStart" class="easyui-datebox"
                ...
                <div class="p-0">
                    S/D: 
                        <input id="SelectFinish" name="SelectFinish" class="easyui-datebox" style="width:110px; height:28px;" data-options="formatter:myformatter2, parser:myparser2">
                </div>
            ...
            <div class="p-0">
                <table id="dg-po" class="easyui-datagrid" url="{{ route('get-ct')}}" title="" style="width:99%;"
                    ...
                    <thead>
                        <tr>
                            ...
                            <!-- <th field="belidtpk" styler="styler2">Belidtpk</th> -->
                            <!-- <th field="belipk" styler="styler2">Belipk</th> -->
                            <th field="noinv" styler="styler2">No Inv. / PO</th>
                            <th field="tanggal" styler="styler2">Tgl. Inv</th>
                            <th field="supnm" styler="styler2">Supplier</th>
                            <th field="brgnm" styler="styler2">Keterangan</th>
                            <th field="hrgbeli" styler="styler2">Harga Sat</th>
                            <th field="jmlbeli" styler="styler2">Qty</th>
                            <th field="jmlhrg" styler="styler2">Jumlah</th>
                            <th field="user" styler="styler2">User</th>
                            <th field="nobg" styler="styler2">No BG</th>
                            <th field="tglaju" styler="styler3">Tgl Aju</th>
                        </tr>
                    </thead>
                </table>
            </div>
