...
<script>
    ...
    $(document).ready(function () {
        $('#filterByStatusPembayaran').combobox({
            onLoadSuccess: function () {
                ...
                loadDataByFilter(); // load data pertama kali
            }
        });
    });
    ...
    function KlikPrint() {
        ...
        const query = Object.entries(params)
            ...
            .join('&');
        window.location.href = `{{ route('pdf.cg') }}?${query}`;
    }
...
<div class="main-wrapper">
    <div class="container-fluid p-4">
        <div class="d-flex flex-column">
            <div class="p-2">
                <span class="txt-000000-700-24-28">Laporan Pembayaran Cash - Giro</span>
            </div>
                ...
                <div class="p-0 ps-3">
                    <input id="filterByStatusPembayaran" name="filterByStatusPembayaran" class="easyui-combobox" method="get"
                        data-options="
                            ...
                            onLoadSuccess:function(){
                                $(this).combobox('setValue', '1'); // Set default to 'CASH BELUM BAYAR'
                            }
                        ">
                </div>
            ...
            <div class="p-0">
                <table id="dg-po" class="easyui-datagrid" url="{{ route('get-cg')}}" title="" style="width:99%;"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th field="tglbayar" styler="styler2">Tgl. Bayar</th>
                            <th field="jmlbayar" styler="styler2">Jml. Bayar</th>
                            <th field="cg" styler="styler2">Cash/BG</th>
