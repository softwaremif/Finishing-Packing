                            ...
                            <div class="card-header bg-white py-3 border-0">
                                ...
                                <div class="d-flex align-items-center gap-2 mt-2">
                                    <div class="input-group" style="width:280px;">
                                        ...
                                        <input type="text" class="form-control search" id="inspecCartonSearch"
                                            placeholder="Cari carton / barcode / PO / OP..." oninput="filterInspecCartonList()">
                                    </div>
                                    <button type="button" class="btn btn-sm btn-outline-secondary" onclick="toggleAllInspecCarton(true)">
                                        <i class="fas fa-angles-down"></i> Buka Semua
                                    </button>
                                    <button type="button" class="btn btn-sm btn-outline-secondary" onclick="toggleAllInspecCarton(false)">
                                        <i class="fas fa-angles-up"></i> Tutup Semua
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="d-flex flex-column gap-3" style="position:sticky; top:0;">
                            ...
                            <div class="card border-0 shadow-sm rounded-3">
                                <div class="card-header bg-white py-3 border-0">
                                    <div class="fw-bold" style="font-size:13px;">
                                        ...
                                        Sample Inspect (<span id="inspecCartCount">0</span> pcs)
                                    </div>
                                </div>
                            ...
                            <div class="card border-0 shadow-sm rounded-3">
                                <div class="card-body">
                                    ...
                                    <label class="form-label fw-semibold" style="font-size:12px;">
                                        Keterangan / Comments (opsional)
                                    </label>
                                    <textarea class="form-control form-control-sm mb-3" id="inspecKeterangan" rows="2" placeholder="Catatan tambahan untuk dokumen ini..."></textarea>
...
<style>
   ...
   teks miring, kesan cap tinta QC beneran). */
    ...
    .inspec-carton-row.is-documented {
        opacity: .55;
    }
    .inspec-carton-row.is-documented .inspec-carton-header {
        cursor: default;
    }
</style>
