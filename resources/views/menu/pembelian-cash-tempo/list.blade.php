...
@section('js_custom')
    <script>
        ...
        function KlikDetail(pk) {
            window.location.href = "{{ url('/') }}/pembelian-cash-tempo/detail/" + pk;
        }
        ...
        function KlikAddPembelian(){
            $.ajax({
                type: "POST",
                url: "{{ route('get.last-pembelian') }}",
                data: {
                    _token: $('meta[name="csrf-token"]').attr('content')
                },
                success: function(data) {
                    console.log(data);
                    const baseUrl = "{{ url('/')}}";
                    window.location.href = baseUrl + "/pembelian-cash-tempo/add-pembelian/" + data.belipk;
                },
        ...
        <div class="container-fluid p-4">
            <div class="d-flex flex-column">
                ...
                <div class="d-flex flex-wrap p-0 pb-2 gap-2 align-items-center">
                    ...
                    <button onclick="KlikAddPembelian();" type="button" class="btn btn-dark" style="height:30px; line-height:30px; padding:0 10px;">&#10010; Create Pembelian</button>
                ...
                <div class="d-none">
                    <table id="dg-po-shadow" class="easyui-datagrid" title="" method="get"
                        url="{{ route('get.pembelian-ct') }}"></table>
                </div>

                <div class="p-0">
                    <table id="dg-po" class="easyui-datagrid" url="{{ route('get.pembelian-ct') }}" title=""
