...
<body>
    {{-- Timestamp Terakhir Diupdate -- dari baris ship TERBARU di
         seluruh scope PO+OP ini ($dtp dari getLatestShipUpdateGlobal()). --}}
    ...
    <table class="info-table">
        <tr>
            ...
            <td width="18%">:
                {{-- Laporan Global tidak mengenal konsep "gabung" seperti
                     laporan biasa -- cukup cek apakah scope PO+OP ini
                     memang mencakup lebih dari 1 customer/place. --}}
        ...
        <tr>
            ...
            <td>:
                {{-- Laporan Global selalu bisa mencakup banyak warna --
                     tampilkan daftar kalau lebih dari 1. --}}
    ...
    <div class="pdf-content-container">
        ...
        <table align="center" width="100%" border="1" id="hor-minimalist-a"
            ...
            {{-- 1 blok (4 baris: Order/Ship/+-/%) PER Color/Sec Size --
            ...
            <tr>
                <td colspan="2" style="text-align:left; padding-left:6px;"></td>
                <th>Order Qty</th>
                @foreach ($activeSizes as $i => $sz)
        ...
        {{-- 2 bagian --
             ...
             2) Carton MIXED (lintas Color/Sec Size dalam 1 carton fisik)
                -- TETAP 1 blok per carton, Color/Sec Size di-rowspan
                DALAM carton itu saja. --}}
        <table width="100%" align="center" border="1" id="hor-minimalist-a"
            ...
            {{-- 2) Carton Mixed antar Color/Sec Size -- carton fisik yang
                 breakdown-nya IDENTIK sekarang DIGABUNG juga: CTN = jumlah
                 carton yang cocok, CARTON NO berisi SEMUA nomor carton
                 yang tergabung. --}}
