...
class SisaProduksiController extends Controller
{
    ...
    public function detailList($popk, Request $request)
    {
        ...
        // FIX UTAMA: reuse getBjAndOutputRows() yang SUDAH ADA (dari fix
        // Breakdown sebelumnya) -- SEKARANG dipakai juga di tabel Detail
        // Data Packing, supaya baris Barcode ikut muncul dengan badge.
